...
If your repo has a rule on deterministic external boundaries (e.g. `.agent/rules/agent-guide.md`), follow it for timeout, polling, and async-boundary fixes.
...
1. **Read Error Messages Carefully**
   ...
   - Prefer lightweight evidence gathering first (`rg -n` for search, `sed -n` for exact ranges) before reaching for heavier ad hoc scripts
...
2. **Compare Against References**
   ...
   - For framework or tool behavior, prefer official docs over secondary summaries
