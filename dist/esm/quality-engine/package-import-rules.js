...
// Registry
// ============================================================================
const GENERIC_SHARED_FUNCTIONS = [];
const WEBPRESSO_SHARED_FUNCTIONS = [
...
export const SHARED_FUNCTION_PROFILES = {
 ...
 */
export const SHARED_FUNCTIONS = SHARED_FUNCTION_PROFILES.generic;
...
export function getSharedFunctions(profile = 'generic') {
    return SHARED_FUNCTION_PROFILES[profile];
}
export function getSharedFunctionNames(profile = 'generic') {
 ...
 */
function isLikelyArrowFunction(content, matchIndex, matchLength) {
 ...
 */
function extractArrowFunctions(content, pattern, existingNames) {
    const names = [];
    let match = pattern.exec(content);
    while (match !== null) {
        const name = match[1];
 ...
 */
function extractFunctionExpressions(content, pattern, existingNames) {
    const names = [];
    let match = pattern.exec(content);
    while (match !== null) {
        const name = match[1];
 ...
 */
export function extractFunctionDefinitions(content) {
 ...
 */
export function findDuplicateFunctions(fileContent, options = {}) {
 ...
 */
export function createBlockedResult(sharedFunc) {
...
//# sourceMappingURL=package-import-rules.js.map