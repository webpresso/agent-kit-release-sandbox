import { getPackageShortName } from './target-resolver.js';
 ...
 */
export function generateLogPath(command, options = {}) {
...
export function extractPackageLogContext(filter) {
...
export function defaultPackageLogContext(filters) {
 ...
 */
export function extractLogContext(resolved, options = {}) {
    const { packageContext = defaultPackageLogContext, fileContext = () => String(Date.now()) } = options;
