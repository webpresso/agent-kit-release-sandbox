...
export type ValidationErrorCode = 'TEMPLATE_NOT_FOUND' | 'TEMPLATE_PARSE_ERROR' | 'MISSING_REQUIRED_FRONTMATTER' | 'INVALID_FRONTMATTER_VALUE' | 'MISSING_REQUIRED_SECTION' | 'INVALID_SECTION_CONTENT' | 'LLM_BLOCK_INVALID_SECTION' | 'DUPLICATE_SECTION';
