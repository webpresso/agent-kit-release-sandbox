import { getBenchSessionMemoryCommandHelpText, getBenchSessionMemoryHelpText, runBenchSessionMemoryCommand, } from '#cli/commands/bench/session-memory.js';
export function getBenchHelpText() {
    return [
        'wp bench',
        '',
...
export function registerBenchCommand(cli) {
    cli
        ...
        const result = await runBenchSessionMemoryCommand({
            ...
            trials: typeof options.trials === 'number'
                ? options.trials
